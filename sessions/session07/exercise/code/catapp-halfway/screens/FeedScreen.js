...
export default function FeedScreen({ personName, setPersonName, amountInGrams, setAmountInGrams, feedNotes, setfeedNotes, catName }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.label}>1. Person who fed {catName}</Text>
      <TextInput
        style={styles.input}
